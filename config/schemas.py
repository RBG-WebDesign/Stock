...
class MasterAnalystOutput(BaseModel):
    ...
    fundamental_catalyst: str = Field(..., description="A 1-2 sentence summary of the strongest fundamental driver (e.g., EPS growth, margins).")
    ...
    bull_case: str = Field(..., description="A concise thesis for why this trade will succeed.")
    bear_case_risks: str = Field(..., description="A concise thesis for the biggest risks or why this trade might fail.")
